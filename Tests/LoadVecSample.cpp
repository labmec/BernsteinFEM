...
int main ()
{
    ...
    TPZVec<REAL> functionEvaluated(integrationPoints.n_rows); // creates the vector which will hold the values for the evaluation of the function in the integration points
