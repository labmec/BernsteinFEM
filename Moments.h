...
class BMoment1D
{
    ...
    bool fSet = false; // is true if the function value of definition are set
    ...
    // initialize Bmoment by the values of the function
    void init_Bmoment_Cval ();
    void init_Bmoment_Def ();
...
class BMoment2DTri
{
    ...
    bool fSet; // is true if the function value or definition is set
